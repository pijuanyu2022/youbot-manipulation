...
disp('Generating bestScript csv file.')
...
csvwrite('bestScript.csv', Matrix_conf)%generate csv file for animation
disp('Writing error plot data.')
csvwrite('Xerr data in best result.csv', Matrix_error)%generate csv file of error data
